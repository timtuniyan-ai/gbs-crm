...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-blue-50 focus:text-gray-900 relative flex w-full cursor-default items-start gap-2 rounded-md py-3 pr-8 pl-3 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-gray-50 transition-colors",
        className,
      )}
      {...props}
    >
