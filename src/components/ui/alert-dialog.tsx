...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn("text-lg font-semibold break-words min-w-0", className)}
      {...props}
    />
  );
}
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn("text-muted-foreground text-sm break-words min-w-0 overflow-hidden", className)}
